[![Latest version](https://img.shields.io/npm/v/@hutechwebsite/cupiditate-sint-nam-perspiciatis.svg)](https://www.npmjs.com/package/@hutechwebsite/cupiditate-sint-nam-perspiciatis)

# `@hutechwebsite/cupiditate-sint-nam-perspiciatis`
...
```bash
npm install @hutechwebsite/cupiditate-sint-nam-perspiciatis
```
...
```js
import { ClientRequestInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/ClientRequest'
...
```js
import { BatchInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis'
import { ClientRequestInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/ClientRequest'
import { XMLHttpRequestInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/XMLHttpRequest'
...
```js
import { BatchInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis'
import nodeInterceptors from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/presets/node'
...
```js
import { BatchInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis'
import browserInterceptors from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/presets/browser'
...
```js
import { WebSocketInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/WebSocket'
...
```js
// child.js
import { RemoteHttpInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/RemoteHttpInterceptor'
import { ClientRequestInterceptor } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/ClientRequest'
...
import { RemoteHttpResolver } from '@hutechwebsite/cupiditate-sint-nam-perspiciatis/RemoteHttpInterceptor'
